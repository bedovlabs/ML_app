...
class Supervised_knn(object):
    ...
    def knn_tut(self):      
        ...
        with How_it_work:
            ...
            how_col2.image("media/knearst2.png")
            how_col1.subheader("Application")
            how_col1.image("media/knearst3.png")
            how_col2.subheader("Advantages and Disadvantages")
            how_col2.image("media/knearst4.png")
    ...
    def knn_inaction(self):      
        ...
        self.n_neighbors=col1.slider("No of neighbors",3,15,1)
        self.algorithm=col1.selectbox("Algorithm",options=['auto', 'ball_tree', 'kd_tree', 'brute'])
        main_page.alignh(3,col2)
        self.leaf_size=col2.slider("leaf size",10,100,5)
        articles_tab,tab_irrig,tab_diabetes=st.tabs(("Article Classification","Smart Irrigation","Diabetes"))
        tab_diabetesData,tab_diabetesGraphs=tab_diabetes.tabs(("Data","Graphs"))
