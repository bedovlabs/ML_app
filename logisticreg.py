    ...
    def logitic_tut(self):      
        ...
        with Try_algorithm:
            ...
            if Generate_dataBTN:
                ...
                components.html(graph.to_jshtml(), height=600,width=600,scrolling=True)
        with How_it_work:
            how_col1,how_col2=How_it_work.columns((9,1))
...
#
    ...
    def logiticaction(self):   
        ...
        tabiris,tabdiabetes,tab_irrig=st.tabs(("Iris flower Classification","Diabetes Prediction","Smart Irrigation"))
        tabirisData,tabirisGraphs=tabiris.tabs(("Data","Graphs"))
        
        tabdiabetData,tabdiabetGraph=tabdiabetes.tabs(("Data","Graphs"))
        tab_irrigData,tab_irrigGraph=tab_irrig.tabs(("Data","Graphs"))


      #  with tabiris:
        with tabirisData:
            col1.subheader("Set Logistic Regression  Parameter")
            fulllist=['l1', 'l2', 'elasticnet', 'none']
            clfoption1=[ 'l2']
            clfoption2=[ 'l2','none']
            Solver=col1.selectbox("Solver",options=['newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'])
