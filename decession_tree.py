...
class Supervised_decession_tree(object):
    ...
    def dec_tree_tut(self):      
        ...
        with How_it_work:
            how_col1,how_col2=How_it_work.columns((5,5))
            how_col1.image("media/decession tree1.png")
            how_col2.subheader("Data piplining")
            how_col2.image("media/decession tree2.png")
            how_col1.subheader("Information Gain")
            how_col1.image("media/decession tree3.png")
            how_col2.subheader("Attribute selection Measure propagation")
            how_col2.image("media/decession tree4.png")
    ...
    def dec_tree_inaction(self):      
        ...
        tabiris,tab_images,tab_irrig,tab_diabet=st.tabs(("Iris flower Classification","Image Classification","Smart Irrigation",'Diabetes'))
        tabirisData,tabirisGraphs=tabiris.tabs(("Data","Graphs"))
        
        tab_imagesData,tab_imagesGraph=tab_images.tabs(("Data","Graphs"))
        tab_irrigData,tab_irrigGraph=tab_irrig.tabs(("Data","Graphs"))
        tab_diabetesData,tab_diabetesGraphs=tab_diabet.tabs(("Data","Graphs"))

        col1.subheader("Set decession tree Parameter")
        self.criterion=col1.selectbox("Criterion",options=['gini', 'entropy', 'log_loss'])
        self.max_depth=col1.slider("Max Depth",1,10,1)
