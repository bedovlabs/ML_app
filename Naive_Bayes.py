...
class supervised_naive(object):
    ...
    def naive_tut(self):
        ...
        with How_it_work:
            ...
            how_col2.subheader("Naive Bayes Data piplining")
            how_col2.image("media/naive_classifier3.png")
    ...
    def naive_inaction(self):
        ...
        col1.subheader("Set Naive Bayes Parameter")
       
        naiev_algorithm=col1.selectbox("Algorithm",options=['GaussianNB', 'MultinomialNB', 'ComplementNB','BernoulliNB'])
        main_page.alignh(3,col2)

        Alpha=col2.slider("Alpha",0.1,1.0,0.1)

       
        tab_smoke,tab_irrig,tab_digit,tab_diabet=st.tabs(("Smoke Detection","Smart Irrigation"," Digit Recognition",'Diabetes'))
        tab_smokeData,tab_smokeGraphs=tab_smoke.tabs(("Data","Graphs"))
        tab_irrigData,tab_irrigGraph=tab_irrig.tabs(("Data","Graphs"))
        tab_digitData,tab_digitGraph=tab_digit.tabs(("Data","Graphs"))
